      ...
      child: Container(
        ...
        child:Column(
          ...
          children: <Widget>[
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(height: 6,),
                          Text(widget.messageText,style: TextStyle(fontSize: 13,color: Color.fromARGB(255, 88, 94, 147), fontWeight: widget.isMessageRead?FontWeight.bold:FontWeight.normal),),
                        ],
                      ),
                    ),
                  ),
            ...
            Text(widget.time,style: TextStyle(color: Colors.white54, fontSize: 12,fontWeight: widget.isMessageRead?FontWeight.bold:FontWeight.normal),),
          ],
        ),
      SizedBox(height: 5,),
        Container(color: Colors.grey[800],height: 1,)
        ]),
      ),
    );
  }
