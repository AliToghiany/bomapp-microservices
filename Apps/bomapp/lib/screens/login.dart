...
class _LoginPageState extends State<LoginPage> {
  ...
  FilteringTextInputFormatter.allow(RegExp(r'[0-9]')),
                  ...
                  borderSide: BorderSide(color: Color.fromARGB(255, 88, 94, 147), width: 2.0),
                   ),

                      labelText: 'Phone',  
                      labelStyle: TextStyle(color: Color.fromARGB(255, 88, 94, 147)),
                ...
                Text("Please select your country and then enter your number",style: TextStyle(color: Colors.white38),) 
        ...
        showModalBottomSheet<void>(
            ...
            padding: EdgeInsets.only(right: 70,left: 70,top: 10),  
                  child: Column(
                    ...
                    children: <Widget>[
                       Text("Please enter the code that was sent to you ",style: TextStyle(color: Colors.white38),) ,
                       SizedBox(height: 20,)
                 , PinCodeTextField(
                    appContext: context,
  ...
  pinTheme: PinTheme(
    ...
    fieldHeight: 40,
    fieldWidth: 40,
inactiveFillColor:Color.fromRGBO(38,37,44,1.0),
...
TextButton(
  ...
  onPressed: () async{
   ...
   var resConfirm= await autoService.ConfirmCode(res.data,codeController.text);
  ...
  ,style: ButtonStyle(backgroundColor: MaterialStateColor.resolveWith((states) => Color.fromARGB(255, 88, 94, 147)),
minimumSize: MaterialStateProperty.all(Size(MediaQuery.of(context).size.width,55))
  )
