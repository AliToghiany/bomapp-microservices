    ...
    private static readonly IHost _host = Host
        ...
        .ConfigureServices((context, services) =>
        {
          ...
          // services.AddScoped<INavigationWindow, Container>();
            ...
            services.AddScoped<bomapp.Views.Pages.Dashboard>();
            services.AddScoped<DashboardViewModel>();

            services.AddScoped<bomapp.Views.Pages.ExperimentalDashboard>();
            services.AddScoped<ExperimentalViewModel>();

            services.AddScoped<bomapp.Views.Pages.Controls>();

            services.AddScoped<bomapp.Views.Pages.Menus>();

            services.AddScoped<bomapp.Views.Pages.Colors>();
            services.AddScoped<ColorsViewModel>();

            services.AddScoped<bomapp.Views.Pages.Debug>();
            services.AddScoped<DebugViewModel>();

            services.AddScoped<bomapp.Views.Pages.Buttons>();
            services.AddScoped<ButtonsViewModel>();

            services.AddScoped<bomapp.Views.Pages.Data>();
            services.AddScoped<DataViewModel>();

            services.AddScoped<bomapp.Views.Pages.Input>();
            services.AddScoped<InputViewModel>();

            services.AddScoped<bomapp.Views.Pages.Icons>();
            ...
            services.AddTransient<bomapp.Views.Windows.EditorWindow>();
            services.AddTransient<bomapp.Views.Windows.SettingsWindow>();
            services.AddTransient<bomapp.Views.Windows.StoreWindow>();
            services.AddTransient<bomapp.Views.Windows.ExperimentalWindow>();
