...
namespace bomapp.Views.Windows
{
    ...
    public partial class EditorWindow : Wpf.Ui.Controls.UiWindow
    {
...
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Clicked: " + tag, "bomapp");
#endif
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor got focus", "bomapp.Editor");
#endif
            UpdateLine();
        }
        ...
        private void RootTextBox_OnPreviewMouseDown(object sender, MouseButtonEventArgs e)
        {
            if (e.ClickCount > 2)
                return;
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor mouse down", "bomapp.Editor");
#endif
            UpdateLine();
        }
        ...
        {
#if DEBUG
            System.Diagnostics.Debug.WriteLine("DEBUG | Editor key up", "bomapp.Editor");
#endif
            UpdateLine();
        }
