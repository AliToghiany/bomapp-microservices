...
public partial class Container : INavigationWindow
{
    ...
    private void TrayMenuItem_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        System.Diagnostics.Debug.WriteLine($"DEBUG | WPF UI Tray clicked: {menuItem.Tag}", "bomapp");
    }

    private void RootNavigation_OnNavigated(INavigation sender, RoutedNavigationEventArgs e)
    {
        System.Diagnostics.Debug.WriteLine($"DEBUG | WPF UI Navigated to: {sender?.Current ?? null}", "bomapp");
