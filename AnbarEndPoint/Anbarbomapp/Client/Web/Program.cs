using Anbarbomapp.Client.Shared.Shared;
...
namespace Anbarbomapp.Client.Web
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("Anbarbomapp.Client.Shared.wwwroot.appsettings.json"));
