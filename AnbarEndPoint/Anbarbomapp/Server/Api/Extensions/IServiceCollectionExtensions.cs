using Anbarbomapp.Server.Api;
using Anbarbomapp.Server.Api.Models.Account;
using Anbarbomapp.Server.Api.Services.Implementations;
...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class IServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddHealthChecks(this IServiceCollection services, IWebHostEnvironment env, IConfiguration configuration)
        {
            ...
            {
                setup.AddHealthCheckEndpoint("AnbarbomappHealthChecks", env.IsDevelopment() ? "https://localhost:5001/healthz" : "/healthz");
            }).AddInMemoryStorage();
